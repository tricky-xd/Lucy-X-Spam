...
async def start_():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@lucyxspam"))
            await idk(functions.channels.JoinChannelRequest(channel="@lucyxspam"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@lucyXspam"))
            await ydk(functions.channels.JoinChannelRequest(channel="@lucyXspamSupport"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@lucyXspam"))
            await wdk(functions.channels.JoinChannelRequest(channel="@lucyXspamSupport"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@lucyXspam"))
            await hdk(functions.channels.JoinChannelRequest(channel="@lucyXspamSupport"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@lucyXspam"))
            await sdk(functions.channels.JoinChannelRequest(channel="@lucyXspamSupport"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@lucyXspam"))
            await adk(functions.channels.JoinChannelRequest(channel="@lucyXspamSupport"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@lucyXspam"))
            await bdk(functions.channels.JoinChannelRequest(channel="@lucyXspamSupport"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@lucyXspam"))
            await cdk(functions.channels.JoinChannelRequest(channel="@lucyXspamSupport"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@lucyXspam"))
            await ddk(functions.channels.JoinChannelRequest(channel="@lucyXspamSupport"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@lucyXspam"))
            await edk(functions.channels.JoinChannelRequest(channel="@lucyXspamSupport"))
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
         = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)
        smex = await e.get_reply_message()
        if len(e.text) > 12:
            message = str([0])
            a = await e.client.get_entity(message)
